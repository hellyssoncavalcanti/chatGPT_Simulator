...
from server_helpers import (
    ...
    build_web_search_test_error_payload as _build_web_search_test_error_payload_impl,
...
document.getElementById('q')?.addEventListener('keydown', e => {{ if (e.key === 'Enter') buscar(); }});
    ...
    try:
        ...
        return jsonify(_build_web_search_test_error_payload_impl(query, 'Timeout (90s)')), 504

    return jsonify(_build_web_search_test_error_payload_impl(query, 'Sem resposta do browser'))
