...
import config
from shared import browser_queue, profile_concurrency_tracker as _PROFILE_CONCURRENCY_TRACKER
...
from server_busca import bp as _bp_busca
try:
...
app.register_blueprint(_bp_busca)
...
def api_metrics():
    ...
    metrics = {
        ...
        "profile_concurrency": _PROFILE_CONCURRENCY_TRACKER.snapshot(),
