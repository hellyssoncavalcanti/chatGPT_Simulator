...
- Toda ação é registrada em logs/agente_autonomo.log.
"""
...
AGENT_LOG = LOGS_DIR / "agente_autonomo.log"

SIMULATOR_URL = os.getenv("AUTON_AGENT_SIMULATOR_URL", "http://127.0.0.1:3003/v1/chat/completions")
SIMULATOR_MODEL = os.getenv("AUTON_AGENT_MODEL", "ChatGPT Simulator")
API_KEY = os.getenv("AUTON_AGENT_API_KEY", "")

# janelas de ciclo
SLEEP_BETWEEN_CYCLES = int(os.getenv("AUTON_AGENT_CYCLE_SEC", "60"))
SUGGESTION_INTERVAL_SEC = int(os.getenv("AUTON_AGENT_SUGGESTION_SEC", "300"))
MAX_CONTEXT_CHARS = int(os.getenv("AUTON_AGENT_CONTEXT_CHARS", "12000"))

# segurança de patch
MAX_PATCH_BYTES = int(os.getenv("AUTON_AGENT_MAX_PATCH_BYTES", "120000"))
ALLOW_UNSAFE_AUTOFIX = os.getenv("AUTON_AGENT_UNSAFE", "0") == "1"
...
def apply_unified_diff(unified_diff: str) -> tuple[bool, str]:
    ...
    if not ALLOW_UNSAFE_AUTOFIX:
        return False, "AUTON_AGENT_UNSAFE=0: auto patch desabilitado por padrão"
